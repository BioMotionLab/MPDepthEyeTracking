...
namespace MPDepthCore {
    public class TrackingSystem : MonoBehaviour {
        ...
        public async Task StartTrackingCalibration() {
            Debug.Log($"starting calibration of {this.name}");
            await trackingCalibrationProvider.StartCalibration();
        }


        public async Task StartScreenCalibration() {
            await screenCalibrationProvider.StartCalibration();
        }
